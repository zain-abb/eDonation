...
class EditAddress extends StatefulWidget {
  EditAddress(this.address, {Key? key}) : super(key: key);
...
class _EditAddressState extends State<EditAddress> {
  ...
  void initState() {
    ...
    _addressLine1Controller.text = widget.address.addressLineOne;
    _addressLine2Controller.text = widget.address.addressLineTwo;
