...
import 'package:edonation/src/bloc/bloc/saved_bloc.dart';
...
class _SavedPostsState extends State<SavedPosts>
  ...
  void initState() {
    ...
    savedBloc = SavedBloc();
    savedBloc.fetchFirstList();
    controller.addListener(_scrollListener);

    WidgetsBinding.instance!.addPostFrameCallback((_) {
      Future.delayed(
        Duration(seconds: 1),
        () => savedBloc.fetchFirstList().then((value) {
          setState(() {});
        }),
      );
    });
  ...
  List<Map<String, String>> savedPostId = [];
  ...
  _initializeSavedPosts() async {
    ...
    snapshot.docs.forEach((element) {
      savedPostId
          .add({'postId': element['postId'], 'userId': element['userId']});
    });
  }
  ...
  _addToSavedPostsList(Posts post) async {
    ...
    if (snapshot.exists) {
      ...
      setState(() {
        savedPostId.remove({'postId': post.postId, 'userId': post.userId});
      });
      await savedPostsRef
          .doc(userCurrent!.id)
          .collection('saved')
      ...
      ScaffoldMessenger.of(context).hideCurrentSnackBar();
      setState(() {
        savedPostId.add({'postId': post.postId, 'userId': post.userId});
      });
                ...
                if (streamSnapshot.data != null) {
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      String postID = streamSnapshot.data![index]['postId'];
                      String userID = streamSnapshot.data![index]['userId'];
                      ...
                      return StreamBuilder<DocumentSnapshot>(
                        stream: postsRef
                            ...
                            .doc(postID)
                            .snapshots(),
                        builder: (context, innerStreamSnapshot) {
                          if (innerStreamSnapshot.data != null) {
                            Posts post =
                                Posts.fromDocument(innerStreamSnapshot.data!);
                            ...
                            return FutureBuilder(
                              ...
                              builder: (context,
                                ...
                                if (innerFutureSnapshot.hasData) {
                                  ...
                                  donorsList
                                      .addAll(innerFutureSnapshot.data![1]);
          ...
          children: [
            ...
            Container(
              ...
              child: IconButton(
                ...
                icon: Icon(
                  savedPostId.any((id) => id['postId'] == post.postId)
                      ? CupertinoIcons.bookmark_fill
                      : CupertinoIcons.bookmark,
                  color: savedPostId.any((id) => id['postId'] == post.postId)
                      ? CustomColors.primaryColor
