...
class CampaignRequirementScreen extends StatefulWidget {
  CampaignRequirementScreen({Key? key}) : super(key: key);

  static const routeName = '/campaign-requirement';

  @override
  _CampaignRequirementState createState() => _CampaignRequirementState();
}

class _CampaignRequirementState extends State<CampaignRequirementScreen> {
  final _textController = TextEditingController();
  final _formKey = GlobalKey<FormState>();

  String _campaignRequirements = '';
    ...
    if (isValid) {
      ...
      Navigator.of(context).pushNamed(
        ...
        arguments: {
          ...
          'campaignReq': _campaignRequirements,
        },
      );
    }
  }
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CustomFormFieldLabel(hintText: 'Requirements'),
                              SizedBox(height: 5.h),
                              Form(
                                key: _formKey,
                                child: CustomFormField(
                                  ...
                                  validation: (value) {
                                    return value!.length < 15
                                        ? 'Requirements must be at least 15 characters'
                                        : null;
                                  },
                                  onSave: (value) {
                                    _campaignRequirements = value!;
                                  },
                                ),
                              ),
                              SizedBox(height: 5),
                              Container(
                                ...
                                child: Text(
                                  'Max 64 Character, Min 15 Character',
                                  style: GoogleFonts.openSans(
                                    textStyle: TextStyle(
                                      // ignore: deprecated_member_use
                                      fontSize: 12.ssp,
